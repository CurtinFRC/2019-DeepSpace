...
const std::vector<tButton> ControlMap::lowerLift{ { 1, 4 }, { 2, 21 }, { 3, 28 } };

const std::vector<tButton> ControlMap::liftGoalGround{ { 1, 1 } };
...
// HATCH JOYMAP
const std::vector<tButton> ControlMap::hatchGrab{ { 2, 3 }, { 3, XboxController::kA } };
const std::vector<tButton> ControlMap::hatchRelease{ { 2, 5 }, { 3, XboxController::kY } };
...
// BOX INTAKE JOYMAP
const std::vector<tButton> ControlMap::boxIn{ { 2, 4 }, { 3, XboxController::kB } };   // reversed
const std::vector<tButton> ControlMap::boxOut{ { 2, 6 }, { 3, XboxController::kX } };  // reversed
