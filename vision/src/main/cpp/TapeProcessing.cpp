...
void TapeProcessing::Periodic() {
    ...
    cv::putText(_imgProcessedTrack,"Tape Tracking", cv::Point2f(125,125), cv::FONT_HERSHEY_COMPLEX_SMALL, 1, cv::Scalar(255,0,255)); //text with distance and angle on target
